    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-emerald-50 to-teal-50 px-4 dark:from-slate-950 dark:to-slate-900">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>
            {mode === "login"
              ? "Sign in to your TalentForge ATS account"
              : "Get started with TalentForge ATS — zero-token AI recruiting"}
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 rounded-md bg-muted/50 p-3 text-xs text-muted-foreground">
            ...
            <p className="mt-1">(Run <code className="font-mono">bun scripts/seed-admin.ts</code> to create)</p>
          </div>
